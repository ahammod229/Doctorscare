...
export function DoctorDashboard() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 animate-fadeIn">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-800">Dr. {user?.name} Dashboard</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {[
          ...
          { label: 'Total Patients', value: stats?.totalPatients || 0, icon: <Users className="w-5 h-5" />, color: 'text-emerald-600 bg-emerald-50' },
          { label: 'Pending', value: stats?.pendingAppointments || 0, icon: <Clock className="w-5 h-5" />, color: 'text-amber-600 bg-amber-50' },
